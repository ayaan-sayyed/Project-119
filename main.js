...
score = 0;
    ...
    document.getElementById("Drawn_sketch").innerHTML = Element_of_array;
...
function check_sketch() {
    if(Drawn_Sketch == Sketch){
        ...
        document.getElementById("Score").innerHTML= updated_score;
        }  
        updated_timer= timer_counter +1;
        document.getElementById("Timer").innerHTML= updated_timer;

}

function modelLoaded() {
    console.log("Your Model is Succesfully Loaded :) ");
}
